...
// Uwaga typy string, number, boolean i obiekty będą omówione dodatkowo w innych filamch 
 ...
 // TYP CZYLI CO? Zbiór cech i zachowań przypisany do wartości zaliczanej do danego typu. Z punktu widzenia
// języka JS wartość "100" i 100 czy "true" i true, to zupełnie coś innego i ma inne własciwości i metody
// (w skrócie inaczej się zachowuje i inne rzeczy umożliwia)
...
// Number - liczba (bez podziału na integer(liczba całkowita), float, decimal - czyli bez podziału na liczbę całkowitą
// czy ułamek dziesiętny jak to jest w wielu innych językach programoaniu. )
typeof 222.222;
typeof 1000;
typeof 3.2e10;
typeof NaN;
typeof (2.2 * "a") //konwersja niejawna "a" na liczbę daje NaN, a 2.2 * NaN te też NaN (Not a Number) - wyjasnię
// to szczegółowo (NaN) w materaileo typie number
